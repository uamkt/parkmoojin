...
export const PILLARS: Record<PillarId, Pillar> = {
  ...
  D: {
    ...
    topics: [
      ...
      // ─────────────────────────────────────────────────────────────────────
      // V2.5 NEW — Statesmen at the CBRN Threshold 시리즈 (2026-05-18)
      // 8 신규 페르소나 — 기존 Pillar A 8 사건 (Tokyo/Salisbury/Halabja/Goiania/
      // Anthrax 2001/Bhopal/TMI-2/Aum) 와 100% 중복 회피
      // 모든 글의 canonical = uamkt.com/tp-iq 시리즈 hub
      // ─────────────────────────────────────────────────────────────────────
      {
        topic: "Konrad Adenauer 1951 IG Farben Dissolution: TP-IQ 78 METHODICAL RECONSTRUCTOR",
        angle: "서독 초대 총리 Adenauer 의 IG Farben 해체와 Bayer·BASF·Hoechst 분할 — 산업 차원 CBRN doctrine 의 시초",
        keyEntities: ["Konrad Adenauer", "IG Farben", "Bayer", "BASF", "Hoechst", "Postwar Germany"],
      },
      {
        topic: "박정희 1·21 사태 1968: 한국 CBRN Doctrine 시초 TP-IQ 69→80 DEFENSIVE FOUNDER",
        angle: "1·21 사태 30분 OODA + 향토예비군 창설 — V-Series Defense doctrine 의 정신적 선조",
        keyEntities: ["박정희", "1·21 사태", "김신조", "향토예비군", "한국 CBRN doctrine", "VSI"],
      },
      {
        topic: "Margaret Thatcher Greenham Common 1981-83: TP-IQ 82 ASSERTIVE STRATEGIST",
        angle: "냉전 미사일 배치 결정 — NATO 동맹 동원 + Greenham 시위 관리 + 소련 화학무기 대응 doctrine",
        keyEntities: ["Margaret Thatcher", "Greenham Common", "Cruise Missile", "NATO", "Cold War CBRN"],
      },
      {
        topic: "Yitzhak Rabin Gulf War 1991 SCUD: TP-IQ 76 RESTRAINED COMMANDER",
        angle: "이라크 39발 SCUD 발사 대응 + 이스라엘 보복 자제 doctrine + Patriot 방어 통합",
        keyEntities: ["Yitzhak Rabin", "SCUD missile", "Israel CBRN", "Patriot Defense", "Restraint Doctrine"],
      },
      {
        topic: "Korea 2026 NK_Hazmat_Seoul: V-Series 78 ADAPTIVE COMMANDER Roadmap",
        angle: "북한 도시 CBRN 가상 시나리오 + V-Series Defense doctrine 도입 시 ADAPTIVE 진입 + 인천 UAM 버티포트 통합",
        keyEntities: ["NK_Hazmat_Seoul", "V-Series Doctrine", "Korea CBRN 2026", "ADAPTIVE entry", "인천공항 UAM 버티포트"],
      },
      {
        topic: "Corazon Aquino Pinatubo 1991: Philippines CBRN TP-IQ 71 RESILIENT NEGOTIATOR",
        angle: "Pinatubo 폭발 + Clark Air Base 방사선·화학 우려 + 미군 철수 협상 doctrine",
        keyEntities: ["Corazon Aquino", "Pinatubo", "Clark Air Base", "Philippines", "Radiological Response"],
      },
      {
        topic: "Jacinda Ardern NZ Biosecurity 2019-2020: TP-IQ 83 EMPATHIC OPERATOR",
        angle: "Christchurch 모스크 테러 + COVID 대응 + Biosecurity Act — 공감 leadership 의 CBRN 응용",
        keyEntities: ["Jacinda Ardern", "NZ Biosecurity Act", "Christchurch", "COVID NZ", "Empathic Leadership"],
      },
      {
        topic: "John Major UK Gulf War 1991: TP-IQ 74 CONTINUITY EXECUTOR",
        angle: "Thatcher 후임 영국 총리의 Gulf War CBRN 정책 transition + Saddam WMD 대응",
        keyEntities: ["John Major", "Gulf War UK", "Thatcher Succession", "UK CBRN Policy", "Iraqi WMD"],
      },
    ],
  },
};
